...
MODEL_COLUMNS = frozenset(tuple("optk_" + _t for _t in OPTION_KEY_TYPES) + (
    ...
    "isc_lord_known", "isc_lord_hp", "isc_lord_rank", "isc_lord_units",
    "isc_lord_ap_pct", "isc_lord_is_leader", "isc_lord_in_own_territory",
    "isc_enemy_known", "isc_enemy_hp", "isc_enemy_units", "isc_units_delta",
    "isc_siege", "isc_ally_armies", "isc_enemy_armies",
    "isc_region_ours", "isc_setts_in_province",
