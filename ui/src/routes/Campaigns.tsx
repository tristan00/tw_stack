...
const pickCols: Col<UcbPick>[] = [
  ...
  { key: 'c', label: 'C', align: 'right', value: (r) => r.c ?? 0, render: (r) => n(r.c, 2) },
  {
    ...
    label: 'plays',
    align: 'right',
    help: 'campaigns in the trailing window the selector divided by at this pick',
...
const rankCols: Col<UcbRow>[] = [
  ...
  },
  {
    ...
    label: 'n',
    align: 'right',
    help: 'campaigns this start has recorded inside the trailing window, counting only those with two or more decisions',
    value: (r) => r.n,
    render: (r) => n(r.n),
  },
  {
    ...
    label: 'mean',
    align: 'right',
    help: 'average reward over the trailing window: settlements gained plus lord levels gained',
    value: (r) => r.mean ?? 0,
    render: (r) => num(r.mean),
  },
  {
    ...
    label: 'explore',
    align: 'right',
    help: 'C * sqrt(ln(plays in window) / n); infinite for a start not played inside the window',
    value: (r) => r.explore ?? Number.MAX_SAFE_INTEGER,
    render: (r) => num(r.explore),
  },
  {
